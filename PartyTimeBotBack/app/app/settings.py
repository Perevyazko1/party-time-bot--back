...
SECRET_KEY = 'django-insecure-#d$b@2thn6h4-+53%8@^^cx3da^lijh+4gc)xx5_go*)pa7e3i'
...
CORS_ALLOW_ALL_ORIGINS = True  # Открывает доступ для всех (можно ограничить конкретными доменами)
